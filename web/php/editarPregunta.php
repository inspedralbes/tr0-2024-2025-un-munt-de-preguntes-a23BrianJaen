...
function updatePreguntas($data, $conn)
{
...
function updateRespostas($data, $conn)
{
    // Array de respuestas con su respectivo idResposta y el texto de la respuesta
    $respostes = [
        $data['idResp1'],
        $data['idResp2'],
        $data['idResp3'],
...
updatePreguntas($data, $conn);
updateRespostas($data, $conn);
